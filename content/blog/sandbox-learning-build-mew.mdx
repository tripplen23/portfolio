...
I call the way I learn now **sandbox learning** - Not the term I composed of course, this happens a lot out there in the Internet now.
...
That's the builder's lens — but the same idea applies anywhere but for example if you are an artist - canvas could be your sandbox; if you are a writer - substack or blog pages are. If you are a rapper / music producer, send me your Soundcloud.
...
I use AI every day, but in an economical way. OpenCode, Open Weight models — they're how I move fast.
...
- Do it by hand to understand the concept first, then enhance your productivity with AI.
